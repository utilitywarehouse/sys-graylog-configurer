...
ADD https://raw.githubusercontent.com/Graylog2/graylog-docker/${GITHUB_BRANCH}/config/graylog.conf ./data/config
ADD https://raw.githubusercontent.com/Graylog2/graylog-docker/${GITHUB_BRANCH}/config/log4j2.xml ./data/config
